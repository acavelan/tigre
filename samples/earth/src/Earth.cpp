...
{
    _log->info("Earth::Earth(log, display, context, renderer, content)\n");
}
...
void Earth::drawFrame()
{
    ...
    // Light
    model = rotate(mat4(1.0f), radians(_angle), vec3(0.0f, 1.0f, 0.0f));
